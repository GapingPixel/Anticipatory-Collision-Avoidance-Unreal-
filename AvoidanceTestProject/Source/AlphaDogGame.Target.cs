...
public class AlphaDogGameTarget : TargetRules
{
	public AlphaDogGameTarget(TargetInfo Target) : base(Target)
	{
	...
	{
		ExtraModuleNames.AddRange(new string[] { "AlphaDogGame" });
	}
	
	internal static void ApplySharedAlphaDogTargetSettings(TargetRules Target)
	{
		...
		if (Target.BuildEnvironment == TargetBuildEnvironment.Unique)
		{
			...
			AlphaDogGameTarget.ConfigureGameFeaturePlugins(Target);
		}
		else
		{
			// !!!!!!!!!!!! WARNING !!!!!!!!!!!!!
