...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ADogSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "ADogSettings"

UADogSettingValueDiscrete_OverallQuality::UADogSettingValueDiscrete_OverallQuality()
{
}

void UADogSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();
...
void UADogSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UADogSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UADogSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UADogSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UADogSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UADogSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UADogSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UADogSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
