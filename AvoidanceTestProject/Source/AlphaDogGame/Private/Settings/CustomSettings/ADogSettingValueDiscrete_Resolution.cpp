...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ADogSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "ADogSettings"

UADogSettingValueDiscrete_Resolution::UADogSettingValueDiscrete_Resolution()
{
}

void UADogSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UADogSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UADogSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UADogSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UADogSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UADogSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UADogSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UADogSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UADogSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UADogSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UADogSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UADogSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UADogSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UADogSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UADogSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UADogSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
