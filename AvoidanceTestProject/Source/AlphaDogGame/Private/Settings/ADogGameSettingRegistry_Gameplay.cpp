...
UGameSettingCollection* UADogGameSettingRegistry::InitializeGameplaySettings(UADogLocalPlayer* InLocalPlayer)
{
...

	{
		...
		//----------------------------------------------------------------------------------
		{
			UADogSettingValueDiscrete_Language* Setting = NewObject<UADogSettingValueDiscrete_Language>();
