...
void UADogGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, UADogLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)EADogDisplayablePerformanceStat::Count == 15, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::ClientFPS);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::ServerFPS);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::FrameTime);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::IdleTime);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::Ping);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				UADogSettingValueDiscrete_PerfStat* Setting = NewObject<UADogSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EADogDisplayablePerformanceStat::PacketSize_Outgoing);
