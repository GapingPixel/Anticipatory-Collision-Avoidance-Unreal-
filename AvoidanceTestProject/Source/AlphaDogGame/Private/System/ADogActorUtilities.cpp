...
#include "System/ADogActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(ADogActorUtilities)

EBlueprintExposedNetMode UADogActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
