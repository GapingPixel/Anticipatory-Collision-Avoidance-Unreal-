...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ADogExperienceDefinition)

#define LOCTEXT_NAMESPACE "AlphaDogSystem"

UADogExperienceDefinition::UADogExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UADogExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UADogExperienceDefinition::UpdateAssetBundleData()
{
