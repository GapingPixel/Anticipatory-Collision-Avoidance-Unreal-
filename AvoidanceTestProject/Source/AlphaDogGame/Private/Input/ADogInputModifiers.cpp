...
#include "Input/ADogInputModifiers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ADogInputModifiers)

DEFINE_LOG_CATEGORY_STATIC(LogADogInputModifiers, Log, All);

//////////////////////////////////////////////////////////////////////
// ADogInputModifiersHelpers

namespace ADogInputModifiersHelpers
{
	/** Returns the owning ADogLocalPlayer of an Enhanced Player Input pointer */
	static UADogLocalPlayer* GetLocalPlayer(const UEnhancedPlayerInput* PlayerInput)
	{
		if (PlayerInput)
		{
			if (APlayerController* PC = Cast<APlayerController>(PlayerInput->GetOuter()))
			{
				return Cast<UADogLocalPlayer>(PC->GetLocalPlayer());
			}
		}
		return nullptr;
	}
...
//////////////////////////////////////////////////////////////////////
// UADogSettingBasedScalar

FInputActionValue UADogSettingBasedScalar::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	{
		if (UADogLocalPlayer* LocalPlayer = ADogInputModifiersHelpers::GetLocalPlayer(PlayerInput))
		{
			const UClass* SettingsClass = UADogSettingsShared::StaticClass();
			UADogSettingsShared* SharedSettings = LocalPlayer->GetSharedSettings();
...
//////////////////////////////////////////////////////////////////////
// UADogInputModifierDeadZone

FInputActionValue UADogInputModifierDeadZone::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	EInputActionValueType ValueType = CurrentValue.GetValueType();
	UADogLocalPlayer* LocalPlayer = ADogInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (ValueType == EInputActionValueType::Boolean || !LocalPlayer)
	{
		return CurrentValue;
	}
	
	UADogSettingsShared* Settings = LocalPlayer->GetSharedSettings();
	ensure(Settings);
...
FLinearColor UADogInputModifierDeadZone::GetVisualizationColor_Implementation(FInputActionValue SampleValue, FInputActionValue FinalValue) const
{
...
//////////////////////////////////////////////////////////////////////
// UADogInputModifierGamepadSensitivity

FInputActionValue UADogInputModifierGamepadSensitivity::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	const EADogGamepadSensitivity Sensitivity = (TargetingType == EADogTargetingType::Normal) ? Settings->GetGamepadLookSensitivityPreset() : Settings->GetGamepadTargetingSensitivityPreset();
...
//////////////////////////////////////////////////////////////////////
// UADogInputModifierAimInversion

FInputActionValue UADogInputModifierAimInversion::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	UADogLocalPlayer* LocalPlayer = ADogInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (!LocalPlayer)
	{
