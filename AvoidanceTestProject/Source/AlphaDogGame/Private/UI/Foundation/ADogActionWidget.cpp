...
#include "UI/Foundation/ADogActionWidget.h"
...
FSlateBrush UADogActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* UADogActionWidget::GetEnhancedInputSubsystem() const
{
