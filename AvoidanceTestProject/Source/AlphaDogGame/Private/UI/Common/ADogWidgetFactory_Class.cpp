...
#include "UI/Common/ADogWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(ADogWidgetFactory_Class)

TSubclassOf<UUserWidget> UADogWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
