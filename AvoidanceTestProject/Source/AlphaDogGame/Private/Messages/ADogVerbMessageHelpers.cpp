...
#include "Messages/ADogVerbMessageHelpers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ADogVerbMessageHelpers)

//////////////////////////////////////////////////////////////////////
// FADogVerbMessage

FString FADogVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FADogVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UADogVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UADogVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
/*FGameplayCueParameters UADogVerbMessageHelpers::VerbMessageToCueParameters(const FADogVerbMessage& Message)
{
...
/*
FADogVerbMessage UADogVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FADogVerbMessage Result;
