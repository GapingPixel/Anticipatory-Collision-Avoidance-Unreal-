...
#include "ADogJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the ADog virtual joystick.
 *
 ...
 */
UCLASS(meta=( DisplayName="AlphaDog Joystick" ))
class ALPHADOGGAME_API UADogJoystickWidget : public UADogSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UADogJoystickWidget(const FObjectInitializer& ObjectInitializer);
