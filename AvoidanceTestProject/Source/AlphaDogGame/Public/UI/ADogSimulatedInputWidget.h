...
#include "ADogSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="AlphaDog Simulated Input Widget" ))
class ALPHADOGGAME_API UADogSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UADogSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
