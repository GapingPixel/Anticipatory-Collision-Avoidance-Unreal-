 ...
 */
UCLASS()
class ALPHADOGGAME_API UAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
...
private:
	...
	void Step3_HandleExperienceLoaded(const UADogExperienceDefinition* CurrentExperience);
