...
#include "ADogUserFacingExperienceDefinition.generated.h"
...
class ALPHADOGGAME_API UADogUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="ADogExperienceDefinition"))
