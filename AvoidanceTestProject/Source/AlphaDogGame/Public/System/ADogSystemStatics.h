...
#include "ADogSystemStatics.generated.h"
...
UCLASS()
class ALPHADOGGAME_API UADogSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="AlphaDog", meta = (WorldContext = "WorldContextObject"))
