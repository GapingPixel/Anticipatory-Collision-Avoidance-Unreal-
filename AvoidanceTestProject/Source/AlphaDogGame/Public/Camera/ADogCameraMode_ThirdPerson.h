...
#include "ADogCameraMode.h"
#include "Curves/CurveFloat.h"
#include "ADogPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "ADogCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UADogCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UADogCameraMode_ThirdPerson : public UADogCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FADogPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;

	UPROPERTY(Transient)
	float AimLineToDesiredPosBlockedPct = 1.0f;
