...
#include "ADogInputUserSettings.generated.h"

/** 
 * Custom settings class for any input related settings for the ADog game.
 * This will be serialized out at the same time as the ADog Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class ALPHADOGGAME_API UADogInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class ALPHADOGGAME_API UADogPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
