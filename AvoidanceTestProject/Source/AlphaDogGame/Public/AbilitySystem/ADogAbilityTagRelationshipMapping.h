...
#include "ADogAbilityTagRelationshipMapping.generated.h"
 ...
 */
USTRUCT()
struct FADogAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class ALPHADOGGAME_API UADogAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FADogAbilityTagRelationship> AbilityTagRelationships;
