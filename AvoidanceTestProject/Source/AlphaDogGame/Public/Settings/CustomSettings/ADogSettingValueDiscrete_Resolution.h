...
#include "ADogSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UADogSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UADogSettingValueDiscrete_Resolution();
