...
#include "ADogSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UADogSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UADogSettingValueDiscreteDynamic_AudioOutputDevice() = default;
