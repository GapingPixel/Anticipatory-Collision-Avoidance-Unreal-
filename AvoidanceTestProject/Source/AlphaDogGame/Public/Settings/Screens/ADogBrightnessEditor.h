...
#include "ADogBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UADogBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UADogBrightnessEditor(const FObjectInitializer& Initializer);
