...
#include "ADogSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UADogSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UADogSafeZoneEditor(const FObjectInitializer& Initializer);
