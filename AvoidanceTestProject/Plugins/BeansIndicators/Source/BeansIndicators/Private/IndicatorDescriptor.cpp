...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UBeansIndicatorManagerComponent* InManager)
{
...
{
	if (UBeansIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
