...
class BEANSINDICATORS_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UBeansIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UBeansIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UBeansIndicatorManagerComponent> ManagerPtr;
