 ...
 *
 * Pulled from ADog - allows you to have a count of a gameplay tag
 */
USTRUCT(BlueprintType)
struct BEANSGAMEPLAYTAGS_API FGameplayTagStack : public FFastArraySerializerItem
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct BEANSGAMEPLAYTAGS_API FGameplayTagStackContainer : public FFastArraySerializer
{
	GENERATED_BODY()
