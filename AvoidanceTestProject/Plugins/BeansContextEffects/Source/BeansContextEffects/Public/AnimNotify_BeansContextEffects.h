...
#include "AnimNotify_BeansContextEffects.generated.h"

/**
 *
 */
USTRUCT(BlueprintType)
struct BEANSCONTEXTEFFECTS_API FBeansContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct BEANSCONTEXTEFFECTS_API FBeansContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct BEANSCONTEXTEFFECTS_API FBeansContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct BEANSCONTEXTEFFECTS_API FBeansContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/BeansGame.BeansContextEffectsLibrary"))
...
class BEANSCONTEXTEFFECTS_API UAnimNotify_BeansContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAnimNotify_BeansContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FBeansContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FBeansContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FBeansContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FBeansContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
